  ...
  return (
    <div className="flex items-center gap-x-4 max-[500px]:justify-center">
      ...
      <div className="flex items-center gap-1">
        <button
          type="button"
          className="size-10 leading-10 text-gray-300 transition hover:opacity-75 flex justify-center items-center border"
        ...
        <input
          ...
          disabled={true}
          value={quantityCount}
          className="h-10 w-24 rounded text-black border-gray-200 sm:text-sm"
        />
