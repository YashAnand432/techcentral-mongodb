        ...
        <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <form className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
            ...
            <section
              ...
              className="mt-16 rounded-lg bg-gray-500 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8"
            >
              <h2
                id="summary-heading"
              ...
              <dl className="mt-6 space-y-4">
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                  <dt className="flex items-center text-sm text-gray-300">
                    ...
                    <a
                      href="#"
                      className="ml-2 flex-shrink-0 text-gray-300 hover:text-gray-400"
                    >
                  ...
                  <dd className="text-sm font-medium text-gray-300">$5.00</dd>
                </div>
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                  <dt className="flex text-sm text-gray-300">
                    ...
                    <a
                      href="#"
                      className="ml-2 flex-shrink-0 text-gray-300 hover:text-gray-500"
                    >
                      <span className="sr-only">
              ...
              {products.length > 0 && (
                <div className="mt-6">
                  <Link
                    href="/checkout"
                    className="block flex justify-center items-center w-full uppercase bg-gray-550 px-4 py-3 text-base border border-black border-gray-300 font-bold text-white shadow-sm hover:bg-gray-600 focus:outline-none focus:ring-2 
