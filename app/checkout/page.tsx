...
import { config, isValidCardNumber, isValidCreditCardCVVOrCVC, isValidCreditCardExpirationDate, isValidEmailAddressFormat, isValidNameOrLastname } from "@/lib/utils";
...
const CheckoutPage = () => {
  ...
  const makePurchase = async () => {
    if (
      ...
      const response = fetch(`${config.apiURL}/api/orders`, {
        method: "POST",
        headers: {
  ...
  const addOrderProduct = async (
    ...
    const response = await fetch(`${config.apiURL}/api/order-product`, {
      method: "POST", // or 'PUT'
      headers: {
        "Content-Type": "application/json",
      },
  ...
  return (
    <div className="bg-gray-900 text-white">
      ...
      <div
        className="hidden h-full w-1/2 bg-pink-500 lg:block"
        aria-hidden="true"
      />
      <div
      ...
      <main className="relative mx-auto grid max-w-screen-2xl grid-cols-1 gap-x-16 lg:grid-cols-2 lg:px-8 xl:gap-x-48">
        ...
        >
          <div className="mx-auto max-w-lg lg:max-w-none">
            ...
            <ul
              role="list"
              className="divide-y divide-gray-200 text-sm font-medium text-gray-200"
            >
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="flex-auto space-y-1">
                    <h3>{product?.title}</h3>
                    <p className="text-gray-300">x{product?.amount}</p>
                  </div>
                  <p className="flex-none text-white text-base font-medium">
                    ${product?.price}
                  </p>
                  <p></p>
                </li>
            ...
            <dl className="hidden space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-gray-300 lg:block">
              <div className="flex items-center justify-between">
                <dt className="text-gray-200">Subtotal</dt>
                <dd>${total}</dd>
              </div>

              <div className="flex items-center justify-between">
                <dt className="text-gray-200">Shipping</dt>
                <dd>$5</dd>
              </div>

              <div className="flex items-center justify-between">
                <dt className="text-gray-200">Taxes</dt>
                <dd>${total / 5}</dd>
              </div>
          ...
          <div className="mx-auto max-w-lg lg:max-w-none">
              ...
              <div className="mt-6">
                ...
                <div className="mt-1">
                  <input
                    ...
                    name="name-input"
                    autoComplete="text"
                    className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 text-black focus:ring-blue-500 sm:text-sm"
                  />
                </div>
              </div>
            ...
            <section aria-labelledby="shipping-heading" className="mt-10">
              ...
              <div className="mt-6 grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-3">
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-1">
                    <textarea
                      className="textarea textarea-bordered text-black textarea-lg w-full"
                      id="order-notice"
                      name="order-notice"
            ...
            <div className="mt-10 border-t border-gray-200 pt-6 ml-0">
              <button
                ...
                className="w-full rounded-md border border-transparent bg-gray-500 px-20 py-2 text-lg font-medium text-white hover:text-gray-300 shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-gray-50 sm:order-last mb-10 "
              >
                Pay Now
              </button>
            </div>
