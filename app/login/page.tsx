    ...
    <div className="bg-white">
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-900">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <h2 className="mt-6 text-center text-2xl font-normal leading-9 tracking-tight text-white">
          ...
          <div className="bg-gray-800 px-6 py-12 shadow sm:rounded-lg sm:px-12">
            ...
            <div>
              <div className="relative mt-10">
                ...
                <div className="relative flex justify-center pb-4 text-sm font-medium leading-6">
